...
<html data-wf-page="6744125b4028f712efbe2b30" data-wf-site="6744125b4028f712efbe2a96">

<head>
    <meta charset="utf-8">
    <title>Not Found | Equest Institute of Higher Education.</title>
    <meta content="Not Found |  Equest Institute of Higher Education." property="og:title">
    <meta content="Not Found |  Equest Institute of Higher Education." property="twitter:title">
                ...
                <div class="section-gap">
                    <div class="w-layout-blockcontainer container-default w-container">
                        <div class="utility-page-wrap">
                            <div class="content-wrapper-404"><img src="{{ asset('home/images/image-404.png') }}"
                                    alt="Image 404" class="image-404">
                                <h2 class="title-404">Page Not Found</h2>
                                <div class="text-404">The page you are looking for doesn&#x27;t exist or has been moved
                                </div>
                                <a data-w-id="1ff69c0c-e430-f24d-841e-32a19cf21a9f" href=""
                                    ...
                                    <div style="-webkit-transform:translate3d(0px, 0, 0) scale3d(0, 0, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0px, 0, 0) scale3d(0, 0, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0px, 0, 0) scale3d(0, 0, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0px, 0, 0) scale3d(0, 0, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
                                        ...
                                        <div class="button-icon w-embed">
                                            <svgxmlns="http: //www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <div class="cta-block">
                                ...
                                <div class="button-wrapper">
                                    <a href="contact-us.html" class="circle-link-block w-inline-block">
                                        <div class="circle-link-icon w-embed">
                                            <svgxmlns="http: //www.w3.org/2000/svg" width="44" height="44"
                                        ...
                                        </div><img src="{{ asset('home/images/contact-us-circular-text.svg') }}"
                        ...
                        <div class="w-layout-blockcontainer container-default w-container">
                            <div class="footer-main-block">
                                <div id="w-node-_1e83ad58-3581-5f38-e940-99c6d1baba99-d1baba8b"
                                    ...
                                    <a href="" class="footer-brand w-inline-block"><img width="86"
                                ...
                                <div class="footer-column">
                                    ...
                                    <div class="footer-link-wrapper">
                                        <a href="#" class="footer-link">Teams and
                                            Condition</a>
                                        <a href="#" class="footer-link">Privacy Policy&#x27;s </a>
                                    </div>
                                </div>
                            </div>
                        </div>
