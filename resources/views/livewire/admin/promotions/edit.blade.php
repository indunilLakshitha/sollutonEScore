<div>
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Ranking</h4>
        </div>
        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-3 mt-2">
                                ...
                                @if($current_image)
                                    <div>
                                        ...
                                        <img src="{{ Storage::disk('public')->url($current_image) }}" class="img-thumbnail" style="max-height: 120px;"/>
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Update Ranking
                        </button>
