<div>
    <livewire:comp.breadcumb title="LECTURER" section="Admin" sub="Courses" action="Lecturer Edit">
        <div>
                        ...
                        <div class="edash-settings-content card w-100 overflow-hidden">
                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit="saveLecturer">
                                    ...
                                    <div class="row g-4 mb-4 mt-5">
                                        <div class="col-md-3">
                                            <label class="fw-semibold text-muted"> Post</label>
                                        </div>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" wire:model='post'
                                                placeholder="Lecturer Post" />
                                            @error('post')
                                                <div style="color: red">
                                                    {{ $message }}
                                                </div>
