            ...
            <div class="section-gap is-registerform">
                ...
                <div class="w-layout-blockcontainer container-default w-container">
                    <div class="register-form-wrapper">
                        <div id="w-node-_24026d05-5415-ce81-2e1e-26a7b8260504-ccf1dfc8"
                            class="max-width-large align-center">
                            <div class="contact-us-form-block is-checkout">
                                <div class="section-title-wrapper center">
                                    <div class="overflow-hidden">
                                        <h2 data-w-id="091f6b78-4fb7-0735-892a-8495dcab8441"
                                            ...
                                            class="section-title is-credintail">Payment Method</h2>
                                    </div>
                                    {{-- <div class="overflow-hidden">
                                ...
                                <div class="contact2_form-block w-form">
                                    <form id="wf-form-Registration-Form" name="wf-form-Registration-Form"
                                        data-name="Registration Form" method="get" class="contact2_form"
                                        data-wf-page-id="6780f516949177b3ccf1dfc8"
                                        ...
                                        <div class="form_field-wrapper">
                                            <div class="price-table">
                                                ...
                                                <div data-current="Tab 1" data-easing="ease" data-duration-in="100"
                                                    ...
                                                    <div class="flex-price-wrap w-tab-menu">
                                                        <a data-w-tab="Tab 1"
                                                            class="price-box-tall w-inline-block w-tab-link w--current">
                                                            <div class="flex-row-outer">
                                                                <div class="price-name">BANK DEPOSIT</div>
                                                            </div>
                                                            <div class="price-description">Transfer &amp; send the slip
                                                            </div>
                                                            <div class="tab-radio-button"></div>
                                                            <div class="recommended">Recommended</div>
                                                        </a>
                                                        <a data-w-tab="Tab 2"
                                                            class="price-box-tall w-inline-block w-tab-link">
                                                            <div class="flex-row-outer">
                                                                <div class="price-name">ONLINE PAYMENT</div>
                                                            </div>
                                                            <div class="price-description">Coming Soon!</div>
                                                            <div class="tab-radio-button"></div>
                                                        </a>
                                                    </div>
                                                    <div class="w-tab-content">
                                                        <div data-w-tab="Tab 1" class="w-tab-pane w--tab-active">
                                                            <div id="w-node-b9c22a8f-a99f-5b3a-eda6-e5b4b93d1e23-ccf1dfc8"
                                                                class="register-margin-top">
                                                                <a wire:click='setPaid()'
                                                                    class="nav-menu-button-2 is-checkout w-button">MAKE THE PAYMENT</a>
                                                            </div>
                                                        </div>
                                                        <div data-w-tab="Tab 2" class="w-tab-pane">
                                                            <div id="w-node-_3e532503-cefc-7e96-f837-00fbef070d67-ccf1dfc8"
                                                                class="register-margin-top">
                                                                <a href="#"
                                                                    class="nav-menu-button-2 is-checkout coming-soon w-button">COMING SOON!</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
