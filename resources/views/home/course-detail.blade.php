...
<html data-wf-page="6770f8c617633dd936b5deb7" data-wf-site="6744125b4028f712efbe2a96">

<head>
    <meta charset="utf-8">
    <title>Single Course</title>
    <meta content="Single Course" property="og:title">
    <meta
        content="https://cdn.prod.website-files.com/6744125b4028f712efbe2a96/67820d51bcc1aee9221799ee_equest-og.png')}}"
        property="og:image">
    <meta content="Single Course" property="twitter:title">
    <meta
        content="https://cdn.prod.website-files.com/6744125b4028f712efbe2a96/67820d51bcc1aee9221799ee_equest-og.png')}}"
...
<body>
    <main id="top" class="page-wrapper">
        ...
        <livewire:home.course-detail course_id="{{ $course_id }}" />
                        ...
                        <div class="w-layout-blockcontainer container-default w-container">
                            <div class="footer-main-block">
                                ...
                                <div class="footer-column">
                                    ...
                                    <div class="footer-link-wrapper">
                                        <a href="terms-and-conditions.html" class="footer-link">Teams and
                                            Condition</a>
                                        <a href="privacy-policy.html" class="footer-link">Privacy Policy&#x27;s </a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            // Map sidebar text to corresponding tab data-w-tab values
            const sidebarToTabMap = {
                "Introduction": "Tab 1",
                "Course Structure": "Tab 2",
                "Lectures": "Tab 3",
                "Investment": "Tab 4",
                "FAQs": "Tab 5"
            };
            ...
            sidebarLinks.forEach(link => {
                link.addEventListener("click", (event) => {
                    ...
                    const clickedText = link.querySelector(".service-category-title-v2").textContent
                        .trim();
                    // Find the corresponding tab
                    const targetTab = sidebarToTabMap[clickedText];
                    if (targetTab) {
                        // Remove active class from all sidebar links
                        sidebarLinks.forEach(link => link.classList.remove("is-active-tab"));
                        // Add active class to the clicked link
                        link.classList.add("is-active-tab");
