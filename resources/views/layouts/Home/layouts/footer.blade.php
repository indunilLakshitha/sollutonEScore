                            ...
                            <a href="#" class="circle-link-block w-inline-block">
                                <div class="circle-link-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path
                                            ...
                                            fill="#4D54CE"></path>
                                    </svg></div><img src="{{ asset('home/images/contact-us-circular-text.svg') }}"
                                    loading="lazy" data-w-id="1e83ad58-3581-5f38-e940-99c6d1baba95" alt="Circular Text"
                                    class="circular-text">
                            </a>
                        </div>
                    </div>
                ...
                <div class="w-layout-blockcontainer container-default w-container">
                    <div class="footer-main-block">
                        <div id="w-node-_1e83ad58-3581-5f38-e940-99c6d1baba99-d1baba8b" class="footer-about-wrapper">
                            <a href="#" aria-current="page" class="footer-brand w-inline-block w--current"><img
            ...
            <div class="footer-lower-block">
                <div class="w-layout-blockcontainer container-default w-container">
                    <div class="footer-copyright-text">Copyright © 2024 <a
                            href="#" target="_blank" class="cc-text">Equest
